...
public class UpdateSubCategoriaDtoValidator : AbstractValidator<UpdateSubCategoriaDto>
{
    public UpdateSubCategoriaDtoValidator(ICategoriaRepository categoriaRepository)
    {
        RuleFor(x => x.Nombre)
